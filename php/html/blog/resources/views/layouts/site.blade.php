...
<div id="page">
    ...
    <header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner"
            style="background-image:url({{asset('images/img_1.jpg')}});" data-stellar-background-ratio="0.5">
            ...
            <div class="row row-pb-md">
                ...
                <div class="col-md-4">
                    <div class="post-entry">
                        <div class="post-img">
                            <a href="#"><img src="{{asset('images/img_1.jpg')}}" class="img-responsive"
                ...
                <div class="col-md-4">
                    <div class="post-entry">
                        <div class="post-img">
                            <a href="#"><img src="{{asset('images/img_2.jpg')}}" class="img-responsive"
                                             alt="Free HTML5 Bootstrap Template by GetTemplates.co"></a>
                        </div>
                        <div class="post-copy">
                            <h4><a href="#">How Web Hosting Can Impact Page Load Speed</a></h4>
                ...
                <div class="col-md-4">
                    <div class="post-entry">
                        <div class="post-img">
                            <a href="#"><img src="{{asset('images/img_3.jpg')}}" class="img-responsive"
                                             alt="Free HTML5 Bootstrap Template by GetTemplates.co"></a>
                        </div>
                        <div class="post-copy">
                            <h4><a href="#">How Web Hosting Can Impact Page Load Speed</a></h4>
